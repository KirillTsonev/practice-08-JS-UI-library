...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.carousel = function () {
  for (let i = 0; i < this.length; i++) {
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(`#${sliderId} .carousel-indicators`).click(e => {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.modal = function (created) {
  for (let i = 0; i < this.length; i++) {
    ...
    closeElements.forEach(a => {
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(a).click(() => {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.tab = function () {
  for (let i = 0; i < this.length; i++) {
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).add('click', () => {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.setAttribute = function (attributes, value) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.removeAttribute = function (attributes) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeIn = function (dur, fin) {
  let display = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "block";
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeToggle = function (dur, fin) {
  let display = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "block";
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.add = function (eventName, callback) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.remove = function (eventName, callback) {
  if (!eventName || !callback) {
    return this;
  }
